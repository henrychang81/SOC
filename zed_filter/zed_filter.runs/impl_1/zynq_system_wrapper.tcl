...
set rc [catch {
  ...
  catch { write_sysdef -hwdef zynq_system_wrapper.hwdef -bitfile zynq_system_wrapper.bit -meminfo zynq_system_wrapper.mmi -ltxfile debug_nets.ltx -file zynq_system_wrapper.sysdef }
