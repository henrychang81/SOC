...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_MMCM_TYPE" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_MMCM_TYPE { PARAM_VALUE.C_MMCM_TYPE } {
	# Procedure called to update C_MMCM_TYPE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_MMCM_TYPE { PARAM_VALUE.C_MMCM_TYPE } {
	# Procedure called to validate C_MMCM_TYPE
	return true
}
...
proc update_MODELPARAM_VALUE.C_MMCM_TYPE { MODELPARAM_VALUE.C_MMCM_TYPE PARAM_VALUE.C_MMCM_TYPE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_MMCM_TYPE}] ${MODELPARAM_VALUE.C_MMCM_TYPE}
}
